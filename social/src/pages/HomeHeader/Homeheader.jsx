...
import UsepopupClose from "../../components/hooks/UsepopupClose";
            ...
            <div className="user-menu-dropdown" ref={dropMenu}>
              <div className="user-menu-box">
                <div className="user-data-box">
                  <div onClick={handleporfile} className="user-data-box-item">
                    <Avatar />
              ...
              <div className="user-menu-list">
                <ul>
                  ...
                  <li>
                    <a onClick={handleUserLogut} href="#">
                      <div className="user-menu-icon"></div>
                      <div className="user-menu-item">
                        <span>Logout</span>
                      </div>
